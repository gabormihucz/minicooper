...
Writing new tests and solving occuring bugs forced us to understand the logic behind each functions once again. As it had turned out some of them were representing ``bad smells'' [REFERENCE Martin Fowler. Refactoring: Improving the Design of Existing Code. Object Technology Series. Addison Wesley, Pearson Education Inc 2000; Chapter 3]. In order to correct that defect we have undertaken a refactoring process, which modified the old code into a more efficient and easier to maintain one.
