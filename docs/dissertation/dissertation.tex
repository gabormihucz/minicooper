...
\subsection{Template Creator and Template Manager}
...
\subsection{PDF to JSON Conversion}
...
A final product bases on the Client-Server architectural pattern, specified by the architecture diagramme presented below:
...
As the software is supposed to be used locally by a small to medium group of users, it is beneficial to implement its server in a centralised manner. The benefits coming from such a design are the improvement with management and organisation of data, as all of it can be maintained and controlled in a single and consistent structure. It also avoids problems with consistency between multiple copies and any future improvements can be undertaken directly on the server and not on the multiple clients.


%==============================================================================
\section{Iteration One and Two}
