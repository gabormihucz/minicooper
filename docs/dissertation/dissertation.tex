...
When evaluating these solutions the following week, we agreed that these suggestions significantly enhanced our efficiency.
...
We had also managed to re-implement automatic refreshing with pagination on the results page switching to the DataTables plugin. By the end of this iteration we were confident that we were ready to deliver our application.
